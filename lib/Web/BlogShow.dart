...
import 'package:royalmart/Web/videoPlay.dart';
...
// import 'package:royalmart/screen/SearcBlogs.dart';
...
class HomeScreenState extends State<BlogScreen> {
  ...
  static List<Products> featurePoducts = List();
  static List<Products> breakingPoducts = List();
  bool flag=false;
  @override
  void initState() {
...
//                  horizontal: 10,
      ...
      body:flag?Center(child: Text("No blog is avaliable!"),): Container(
          ...
          Stack(
            children: [
              ...
              url1 != null
                  ? InkWell(
                onTap: (){
                  pro.youtube.length>1? Navigator.push(context, MaterialPageRoute(builder: (context) => VideoPlayer(pro)),)
                  :Navigator.push(context, MaterialPageRoute(builder: (context) => WebViewClass(pro.title,Constant.mainurl+pro.url)),);
                ...
                child: Container(
                  ...
                  child:url1!=null||!url1.isEmpty? CachedNetworkImage(
                    fit: BoxFit.fill,
                    imageUrl: pro.youtube.length>1? url1:Constant.Product_Imageurl6+url1,
          ...
          children: [
            Row(
              ...
              /*  Container(
                ...
                Container(
                  child: Text('${post.addedOn.substring(0,10)}  ',
                    style: TextStyle(
            ...
            Container(
              ...
              child: _PostButton(
                  ...
                  onTap: () {
                    print("share");
                    Share.share(Constant.mainurl+post.url);
                  }
              ),
            ),
