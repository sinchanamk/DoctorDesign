...
class
Register extends StatelessWidget {
...
//    _employeeList = _getEmployee();
  ...
  Future _getEmployee() async {
    ...
    final response = await http.post(Uri.parse(Constant.base_url+'api/step1.php'),body:map);
    ...
    return Stack(
      children: <Widget>[
        ...
        Container(
          ...
          margin: EdgeInsets.only(top: _large? _height/20 : (_medium? _height/45 : _height/50)),
          child: Image.asset(
...
//            .showSnackBar(SnackBar(content: Text('Login Successful')));
      ...
      child: Container(
        ...
        child: Text('${getTranslated(context, 'so')}',style: TextStyle(fontSize: _large? 14: (_medium? 12: 10))),
      ),
    );
  }
