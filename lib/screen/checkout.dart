          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text("Deliver TO :", style: TextStyle(color: Colors.black, fontSize: 18),),
              ),
              Row(
              ...
              createAddressText(city1==null?' ':'${city1}:${pin1} ', 6),
...
// String invoicemenual;
  Future _getInvoice1(String paymode) async{
    ...
    map['adate'] ="";
    // textval == "Select Date" || textval.isEmpty ? '':(Jiffy(textval, "dd/MM/yyyy").format("yyyy-MM-dd")).toString();
    map['atime'] ="";
