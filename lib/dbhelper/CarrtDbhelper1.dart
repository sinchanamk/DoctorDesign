...
class DbProductManager1 {
  ...
  Future openDb() async {
    if (_database == null) {
      _database = await openDatabase(
          join(await getDatabasesPath(), "ss7.db"),
  ...
  Future<int> updateStudent(ProductsCart1 products) async {
    await openDb();
...
class ProductsCart1 {
  ...
  ProductsCart1({@required this.pname, @required this.pid,@required this.pimage,@required this.pprice,@required this.pQuantity,@required this.pcolor,
