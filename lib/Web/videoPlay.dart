           ...
           child: Column(
             ...
             children: [
               ...
               Padding(
                   ...
                   child: Text(widget.products.title,style: TextStyle(fontSize: 16),)),

               Padding(
                   padding: EdgeInsets.only(left: 15,right: 15,top: 5),
                   child: Text(widget.products.heading,
                     maxLines: 3,
...
//                                                  =="no-cover.png"? getImage(topProducts[index].productIs):topProducts[index].image,
           ...
           Padding(
               padding: EdgeInsets.only(left: 15,right: 15,top: 5),
               child: Text(pro.menuName,style: TextStyle(fontSize: 14,color: Colors.blueGrey),)),
           Padding(
             padding: const EdgeInsets.all( 12.0),
   ...
   Future _getCount() async {
     ...
     final response = await http.post(Constant.base_url+'api/blogCount.php',body:map);
