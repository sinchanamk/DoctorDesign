...
import 'package:royalmart/screen/serviceDetails.dart';
...
class Screen3 extends StatefulWidget {
  // final String  title;
  // final String id;
  //const Screen3(this.id,this.title) : super();
  @override
    ...
    return Scaffold(
        ...
        InkWell(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => UserFilterDemo('1')),
                );
              },
              child: Padding(
...
//             child: InkWell(
//               onTap: () {
//                 Navigator.push(context, MaterialPageRoute(builder: (context) => ServiceDetails(entry)),);
//               },
//               child: Container(
...
//                               fit: BoxFit.cover,
//                             image: AssetImage(listdemo[index].imagepath)
...
//                                                       child:Text("Book Now",style: TextStyle(color: AppColors.white,fontSize: 12,fontWeight: FontWeight.bold),),
...
//                                   },
//                                   child:
//                                   getSelection(listdemo[index].text),
